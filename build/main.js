...
/***/ function(module, exports, __webpack_require__) {
	...
	var Product = React.createClass({
				...
				render: function () {
							...
							return React.createElement(
										...
										React.createElement(SearchedProduct, { data: passingData })
							);
				}
	});
							...
							return React.createElement(
										...
										React.createElement(
													...
													React.createElement(
																...
																React.createElement('input', { type: 'search', ref: 'searchInput', value: this.props.query, onChange: this.doSearch }),
																React.createElement(
																			'label',
																			null,
																			'search'
										...
										React.createElement(
													...
													React.createElement(
																...
																React.createElement(
																			'i',
																			{ className: 'material-icons', title: 'Add New Product' },
																			'add'
																)
													)
										)
							...
							var productNodes = this.props.data.map(function (product) {
										if (product.item_units < 150) {
													return React.createElement(
																...
																React.createElement(
																			'div',
																			{ className: 'card-panel hoverable #bcaaa4 brown lighten-3' },
																			React.createElement(
																						'div',
																						{ className: 'product' },
																						React.createElement(
																									'span',
																									{ className: 'right teal-text' },
																									product.item_units,
																									' units'
																						),
																						React.createElement(
	...
	ReactDOM.render(React.createElement(ProductList, { url: 'http://localhost:5000/products' }), document.getElementById('ims-app'));
